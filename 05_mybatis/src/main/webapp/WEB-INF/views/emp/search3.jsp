		...
		<div id="search-container">
			<form name="empSearchFrm">
				...
				<table id="tbl-search">
					...
					<tr>
						<th>직급</th>
						<td><c:forEach items="${jobList }" var="job">
								<input type="checkbox" value="${job.jobCode }" name="jobCode"
									id="${job.jobCode }"
					...
					<c:set var="deptIdList" value="${requestScope.param.deptIdList }"></c:set>
					<tr>
						<th>부서</th>
						<td><c:forEach items="${deptList }" var="dept" varStatus="vs">
								<input type="checkbox" name="deptId" id="${dept.deptId }"
									value="${dept.deptId }"
